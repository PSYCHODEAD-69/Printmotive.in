...
/* ══════════════════════════════════════
   CART SYSTEM
   ══════════════════════════════════════ */
let cart = []; // [{product, price, priceNum, desc, qty}]
...
function cartOrderWA() {
  ...
  window.open(`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(buildCartMsg())}`, "_blank");
  closeCart();
}
...
function cartOrderEmail() {
  ...
  window.open(`mailto:${EMAIL}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(buildCartMsg())}`);
  closeCart();
}
